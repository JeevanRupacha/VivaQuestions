  ...
  return (
    <div className="">
      <div className="bg-gray-100 rounded-md">
        ...
        return (<div key={uuidv4()} onClick={() => onClickSubject(subject)} className="hover:bg-gray-50 w-full text-center text-gray-800 cursor-pointer block xl:pl-4 pt-1 pb-3 text-3xl rounded-sm ">{subject.title}</div>)
